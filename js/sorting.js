			...
			if (now_load > 0) {
				if (addon_options.type == 0) {
					...
					for (i = i_start-1; i < i_start+now_load-1; i++) {
						loaded_object = loaded_object + '<div class="element '+ addon_options.items[i].category +' project added"><div class="col-lg-6 col-sm-6 padbot20"><div class="hover_img"><img src="'+ addon_options.items[i].src +'" alt="" /><a class="zoom" href="'+ addon_options.items[i].src +'" rel="prettyPhoto[portfolio1]"></a></div></div><div class="col-lg-6 col-sm-6 padbot20"><h4><a href="'+ addon_options.items[i].url +'" alt="">Single Page</a></h4><p>'+ addon_options.items[i].content +' <a href="'+ addon_options.items[i].url +'" class="more_link">Read more...</a></p></div><div class="clear"></div></div>';
					}
				} else {
